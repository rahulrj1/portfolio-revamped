    ...
    <section id="contact" className="py-24 bg-black text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-6 items-center max-w-4xl mx-auto">
          <a href="mailto:rahuljas2050@gmail.com" className="group flex flex-col items-center justify-center p-8 bg-zinc-900/50 backdrop-blur-sm rounded-2xl hover:bg-zinc-800 transition-all border border-zinc-800 hover:border-blue-500/50 w-full md:w-64 h-48 hover:-translate-y-2 duration-300">
            ...
            <span className="font-medium mt-1">rahuljas2050@gmail.com</span>
          </a>

          <a href="tel:+918058992101" className="group flex flex-col items-center justify-center p-8 bg-zinc-900/50 backdrop-blur-sm rounded-2xl hover:bg-zinc-800 transition-all border border-zinc-800 hover:border-green-500/50 w-full md:w-64 h-48 hover:-translate-y-2 duration-300">
            ...
            <span className="font-medium mt-1">+91-8058992101</span>
          </a>

          <a href="https://linkedin.com/in/rahul-rj" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center justify-center p-8 bg-zinc-900/50 backdrop-blur-sm rounded-2xl hover:bg-zinc-800 transition-all border border-zinc-800 hover:border-blue-700/50 w-full md:w-64 h-48 hover:-translate-y-2 duration-300">
